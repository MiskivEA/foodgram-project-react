    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement_unit', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.ingredient')),
                ('name', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='names', to='app.ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', to='app.ingredientsamount')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
